/*
 * This java program retrieve employee data who joined between particular 
 * date 
 */
	...
	public static void main(String[] args) {
		...
		try (Connection connection = DriverManager.getConnection(url, username, password)) {
			...
			try (Statement statement = connection.createStatement()) {
				String selectQuery = "select * from employee_payroll where  date >= DATE '2018-05-01' AND date < DATE '2021-01-01';";
